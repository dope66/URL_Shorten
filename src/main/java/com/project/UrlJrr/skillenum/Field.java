...
public enum Field {
    ...
    텍스트마이닝(2), 트러블슈팅(2), 펌웨어(2), 플러그인(2), 핀테크(2), 헬스케어(2), AI_인공지능(2), API(2), APM(2), AR_증강현실(2),
    DBMS(2), DevOps(2), DLP(2), DW(2), ERP(2), ETL(2), FPGA(2), GIS(2), H_W(2), IDC(2), IIS(2),
    IoT(2), ISMS(2), MCU(2), Nginx(2), NLP_자연어처리(2), NLU_자연어이해(2), OCR(2), OLAP(2), RDBMS(2), RPA(2), RTOS(2),
    S_W(2), SAP(2), SDK(2), SOA(2), STT(2), TTS(2), UTM(2), VDI(2), VMware(2), VoIP(2), VPN(2), VR_가상현실(2), WCF(2), Windows(2);
