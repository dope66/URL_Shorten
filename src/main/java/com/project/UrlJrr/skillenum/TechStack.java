...
public enum TechStack {
    ...
    ASP(3), ASP_NET(3), AWS(3), Azure(3), Bootstrap(3), C_Sharp(3), C_Plus_Plus(3),
    ...
    MSSQL(3), MyBatis(3), MySQL(3), Node_js(3), NoSQL(3), Objective_C(3), OpenCV(3),
    OpenGL(3), OracleDB(3), OSS(3), PaaS(3), Pandas(3), Perl(3), PHP(3), PL_SQL(3),
    PostgreSQL(3), Pro_C(3), Python(3), Pytorch(3), QGIS(3), Qt(3), R(3),
    React(3), React_Native(3), ReactJS(3), Redis(3), Redux(3), RestAPI(3), Ruby(3), SaaS(3),
    ...
    Unreal(3), VB_NET(3), Verilog(3), Vert_x(3), VisualBasic(3), VisualC_C_plus_plus(3), Vue_js(3), WAS(3),
